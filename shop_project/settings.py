...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-change-me-in-production-dev-key-12345')
...
MIDDLEWARE = [
    ...
    'shop_project.middleware.RateLimitMiddleware',
]
...
PAYMENT_SECRET_KEY = os.getenv('PAYMENT_SECRET_KEY', 'test-secret-key-do-not-use-in-production')
PAYMENT_API_URL = os.getenv('PAYMENT_API_URL', 'https://api.example-gateway.com/v3/payments')
